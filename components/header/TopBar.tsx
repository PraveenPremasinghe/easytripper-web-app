...
export function TopBar() {
  return (
    <div className="fixed top-0 left-0 right-0 z-50 border-b border-white/10 bg-black/20 backdrop-blur-lg supports-[backdrop-filter]:bg-black/30">
        ...
        <div className="flex flex-col items-center justify-between gap-2 text-sm md:flex-row">
          <div className="flex items-center gap-6">
            <Link
              ...
              className="flex items-center gap-2 text-white/95 transition-all duration-200 hover:text-white hover:scale-105 font-medium"
              aria-label="Call us"
            >
