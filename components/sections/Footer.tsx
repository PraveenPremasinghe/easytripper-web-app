      ...
      <div className="relative mx-auto max-w-7xl px-4 py-20 md:px-6 lg:px-8">
        ...
        <div className="grid gap-8 lg:grid-cols-12 mb-16">
          ...
          <div className="lg:col-span-4">
            <div className="mb-8">
              <h3 className="text-4xl md:text-5xl font-bold text-white mb-4 font-serif">Easy Tripper</h3>
            ...
            <div className="flex gap-4 mb-8">
              <Link
                href="#"
                className="p-4 rounded-xl bg-white/10 backdrop-blur-sm border-2 border-white/20 text-white transition-all hover:text-primary hover:bg-white hover:border-primary hover:shadow-xl hover:scale-110 cursor-pointer"
                aria-label="Facebook"
              >
            ...
            <motion.div
              ...
              className="w-200 bg-gradient-to-br from-primary/30 via-accent/30 to-primary/30 rounded-2xl sm:rounded-3xl p-6 sm:p-8 border-2 sm:border-4 border-white/30 shadow-2xl backdrop-blur-sm"
            >
              {/* Phone Icon and Label */}
              <div className="flex items-center gap-3 mb-5">
                <div className="p-3 sm:p-4 rounded-xl bg-white/20 backdrop-blur-sm flex-shrink-0">
                  <Phone className="h-6 w-6 sm:h-7 sm:w-7 text-white" />
                </div>
                <div>
                  <p className="text-xs sm:text-sm font-bold text-white/90 uppercase tracking-wider">Call Us Now</p>
              ...
              >
                <p className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-extrabold text-white group-hover:text-accent transition-colors cursor-pointer leading-none tracking-tight">
                  +94 75 643 3267
                </p>
              </a>
              ...
              <div className="grid grid-cols-2 gap-3">
                <a
                  href="tel:+94756433267"
                  className="inline-flex items-center justify-center gap-2 px-4 sm:px-6 py-3 sm:py-3.5 bg-white text-primary rounded-xl hover:bg-accent hover:text-white transition-all text-sm sm:text-base font-bold shadow-lg hover:shadow-xl hover:scale-[1.02] cursor-pointer"
                >
                ...
                <a
                  ...
                  className="inline-flex items-center justify-center gap-2 px-4 sm:px-6 py-3 sm:py-3.5 bg-[#25D366] text-white rounded-xl hover:bg-[#20BA5A] transition-all text-sm sm:text-base font-bold shadow-lg hover:shadow-xl hover:scale-[1.02] cursor-pointer"
                >
          ...
          <div className="lg:col-span-2">
            <h4 className="mb-6 font-bold text-xl text-white">Quick Links</h4>
          ...
          {/* Services */}
          <div className="lg:col-span-2">
            <h4 className="mb-6 font-bold text-xl text-white">Services</h4>
            <ul className="space-y-4 text-base">
              <li>
          ...
          <div className="lg:col-span-4">
            <h4 className="mb-6 font-bold text-xl text-white">Get In Touch</h4>
            ...
            >
              ...
              <div className="relative w-36 h-36 sm:w-40 sm:h-40  rounded-xl sm:rounded-2xl bg-white p-3 sm:p-4 shadow-xl border-2 sm:border-4 border-white/30">
